...
export class ProductPage extends BaseCatalog {
  //LOCATORS
  private locatorProductH1Title =
    "//h1[@class = 'catalog-masthead__title js-nav-header']";
  private locatorSellerOffersButton =
    "//a[@class='button button_orange button_big offers-description__button js-product-prices-count-link']";
  private locatorMainPrice =
    "//a[@class='offers-description__link offers-description__link_nodecor js-description-price-link']";
  private locatorCheckboxAddToCompare =
    "//li [@id='product-compare-control']//span[@class='i-checkbox__faux']";
  ...
  async clickOnComparisonPopup() {
    ...
    await this.page.waitForURL(`${URLs.comparisonPageUrl}\/**`, {
      waitUntil: "load",
    });
