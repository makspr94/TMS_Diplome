...
export class LoginPage extends BasePage {
  // Locators
  private loginFieldLocator =
    "//input[contains(@class,'auth-input_primary') and @type='text']";
  private passwordFieldLocator =
    "//input[contains(@class,'auth-input_primary') and @type='password']";
  private logInButtonLocator =
    "//button[contains(@class,'auth-button_primary')]";
  private captchaFrameLocator = "//*[contains(@class,'auth-form__captcha')]";
  private authFormLocator = "//*[contains(@class, 'auth-form__body')]";
  private registerButtonLocator =
    "//a[contains(text(), 'Зарегистрироваться на Onlíner')]";
