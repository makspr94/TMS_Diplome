...
export class CartPage extends BasePage {
  //LOCATOR
  private locatorButtonRemoveProduct =
    "//a[@class='button-style button-style_auxiliary button-style_small cart-form__button cart-form__button_remove']";
  private locatorCartProductTitle =
    "//div[@class='cart-form__description cart-form__description_primary cart-form__description_base-alter cart-form__description_font-weight_semibold cart-form__description_condensed-specific']/a";
  private locatorCartBody = "//div[@class='cart-form__body']";
  private locatorProductPrice =
    "//div[@class='cart-form__offers-part cart-form__offers-part_price cart-form__offers-part_price_specific helpers_hide_tablet']//div[@class='cart-form__description cart-form__description_base-alter cart-form__description_font-weight_semibold cart-form__description_ellipsis cart-form__description_condensed']";
  private locatorButtonCheckout =
    "//a[@class='button-style button-style_small cart-form__button button-style_primary']";
  private locatorCheckoutHeader =
    "//div[@class='cart-form__title cart-form__title_base cart-form__title_nocondensed cart-form__title_condensed-other']";

  private locatorFieldStreet =
    "(//span[text()='Доставка']/following::input)[2]";
  private locatorFieldBuilding =
    "(//span[text()='Доставка']/following::input)[3]";
  private locatorFieldName =
    "//div[@id='container']/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[9]/div[1]/div[2]/div[1]/input[1]";
  private locatorFieldPhoneNum =
    "//div[@id='container']/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[10]/div[2]/div[2]/div[1]/input[1]";
  private locatorButtonProceedToPay = "//button";
  private locatorFormAddressSelection =
    "//div[@class='cart-form__choise-item']";
  private locatorCheckboxPaymentTypeCard =
    "//span[@class='cart-form__checkbox-text cart-form__checkbox-text_inline' and contains(text(), 'Картой')]";
  private locatorButtonsPaymentOptions =
    "//div[@class='cart-form__anchor-list']";
  private locatorButtonConfirmOrder =
    "//button[contains(@class,'button-style button-style_primary')]";
  ...
  async clickButtonCheckout() {
    ...
    await this.page.waitForURL("https://cart.onliner.by/order", {
      waitUntil: "load",
    });
