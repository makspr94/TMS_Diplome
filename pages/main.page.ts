...
export class MainPage extends BasePage {
  ...
  private loginButtonLocator =
    "//*[contains(@class,'auth-bar__item') and text()='Вход']";
  private userAvatarLocator =
    "//*[@class = 'b-top-profile__image js-header-user-avatar']";
  ...
  private autoNewsSectionLocator =
    "//div[header/h2/a[contains(text(),'Авто')]]";
