...
export class HeaderMenu extends BasePage {
  //LOCATORS
  private locatorButtonCatalog =
    "//span[contains(@class, 'b-main-navigation__text') and text()='Каталог']";
  ...
  private locatorButtonCurrencyExchange =
    "//span[@class='_u js-currency-amount']";
