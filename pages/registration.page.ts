...
export class RegistrationPage extends BasePage {
  ...
  private passwordLocator =
    "//input[contains(@type, 'password') and contains(@placeholder, 'Придумайте пароль')]";
  private repeatPasswordLocator =
    "//input[contains(@type, 'password') and contains(@placeholder, 'Повторите пароль')]";
  private policyCheckboxLocator =
    "//span[contains(@class, 'auth-checkbox__faux')]";
  private regButtonLocator = "//button[contains(@type, 'submit')]";
  private goToMailButtonLocator = "//a[contains(text(), 'Перейти в почту')]";
  private passwordErrorMessageLocator =
    "//div[div/div/input[contains(@type, 'password') and contains(@placeholder, 'Придумайте пароль')]]//div[contains(text(), 'Укажите пароль')]";
  private repeatPasswordErrorMessageLocator =
    "//div[div/div/input[contains(@type, 'password') and contains(@placeholder, 'Повторите пароль')]]//div[contains(text(), 'Укажите пароль')]";
  private secureBoxMessageLocator =
    "//div[contains(text(), 'Очень надежный пароль')]";
  private confitmEmailFormLocator =
    "//div[@class='auth-form__body']//div[contains(text(), 'Подтвердите') and contains(text(),'ваш')]";
  // Elements
